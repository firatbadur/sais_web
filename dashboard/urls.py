...
urlpatterns = [
    ...
    path("sensor-config/connections/<int:pk>/export/", views.ConnectionExportView.as_view(),
         name="sensorcfg_connection_export"),
    ...
    path("sensor-config/parameters/", views.ParameterConfigListView.as_view(),
         name="sensorcfg_parameters"),
    path("sensor-config/parameters/create/", views.ParameterConfigCreateView.as_view(),
         name="sensorcfg_parameter_create"),
    path("sensor-config/parameters/<int:pk>/edit/", views.ParameterConfigUpdateView.as_view(),
         name="sensorcfg_parameter_edit"),
    path("sensor-config/parameters/<int:pk>/delete/", views.ParameterConfigDeleteView.as_view(),
         name="sensorcfg_parameter_delete"),
    ...
    path("api/mimic/control/", api_views.mimic_control, name="api_mimic_control"),
    path("api/mimic/report/", api_views.mimic_report_data, name="api_mimic_report"),
    ...
    path("api/sensor-config/connection-import/", api_views.connection_import,
         name="api_sensorcfg_connection_import"),
