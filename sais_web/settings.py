...
# kategorize edip biriktirir (teşhis; davranışı değiştirmez). MIN_INTERVAL_SEC
# aynı (connection, sensor, category) için worker-process cooldown'u (hacim sınırı).
